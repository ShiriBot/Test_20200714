...
import kr.co.tjoeun.test_20200714.ViewPizzaStoreDetailActivity
import kr.co.tjoeun.test_20200714.adapters.PizzaStoreAdapter
...
class FirstFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        mPizzaStoreList.add(PizzaStore("미스터피자", "https://post-phinf.pstatic.net/MjAxODEyMDVfMzYg/MDAxNTQzOTYxOTA4NjM3.8gsStnhxz7eEc9zpt5nmSRZmI-Pzpl4NJvHYU-Dlgmcg.7Vpgk0lopJ5GoTav3CUDqmXi2-_67S5AXD0AGbbR6J4g.JPEG/IMG_1641.jpg?type=w1200", "1577-0077"))
        mPizzaStoreList.add(PizzaStore("도미노피자", "https://pbs.twimg.com/profile_images/1098371010548555776/trCrCTDN_400x400.png", "1577-3082"))

        mAdapter = PizzaStoreAdapter(activity!!,R.layout.pizzastore_list_item,mPizzaStoreList)
